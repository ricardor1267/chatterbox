...
def handler(job):
    ...
    Expected input format:
    {
        "input": {
            ...
            "language_id": "en" (required for multilingual, e.g., "en", "es", "fr", etc.),
            "audio_prompt": "base64_encoded_audio" (optional),
            "exaggeration": 0.5 (optional, default: 0.5),
            "temperature": 0.8 (optional, default: 0.8),
            "cfg_weight": 0.5 (optional, default: 0.5),
            "seed": 0 (optional, 0 for random),
            "min_p": 0.05 (optional, default: 0.05),
            "top_p": 1.0 (optional, default: 1.0),
            "repetition_penalty": 1.2 (optional, default: 1.2)
        }
    }
    ...
    try:
        ...
        text = job_input["text"]
        if len(text) > 500:  # Limit text length for safety
            text = text[:500]
